...
export const getRivalryMatchups = async (userOneID, userTwoID) => {
    ...
    while (curLeagueID && curLeagueID != 0) {
        ...
        // Fetch all matchup data for the season, including playoffs
        const matchupsPromises = [];
        const totalWeeks = leagueData.settings.playoff_week_start + leagueData.settings.playoff_week_count;
